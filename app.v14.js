// VERSION: v14 (buttons fixed, mobile search full width, controls in menu, equal-sized controls, drag-to-scroll + trackpad + iPhone)
'use strict';
...
// Drag-to-scroll (mouse & touch) for iPhone + desktop
...
function render(){
  ...
  // IntersectionObserver tied to this scroller
