// VERSION: v28 — Grid/Flip view, PWA, Stats view, iTunes + Deezer(JSONP)
'use strict';
...
(function(){
  ...
  onReady(async function(){
    ...
    const installBtn=document.getElementById('installBtn'); if(installBtn){ installBtn.addEventListener('click', handleInstall); }
    ...
    if(viewToggle){
      viewToggle.addEventListener('click', ()=>{
        ...
        viewToggle.textContent = 'View: ' + (state.view==='flip' ? 'Flip' : 'Grid');
        render();
      });
    }
